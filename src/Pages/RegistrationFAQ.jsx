...
const RegistrationFAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: (
        <>
          {" "}
          You can register online on our secured website by following this{" "}
          <Link style={{color: "red"}} to="/conference-registration">
            Registration Page
          </Link>
          ...
          and they will promptly answer your questions.{" "}
        </>
      ),
    },
    {
    ...
    {
      question: "Q.6: Is there any discount if I submit 2 research papers?",
      answer:
        "Yes, indeed! We offer a discount for submitting two papers. Reach out to our Program Manager for more details.",
    },
    {
      question: "Q.7: Can you provide me a payment receipt with taxes?",
      answer: "Yes, we'll ensure you get a payment receipt inclusive of taxes.",
    },
    {
      question:
    ...
    {
      question: "Q.10: Is it okay if I will register after the deadline?",
      answer: "Is it okay if I will register after the deadline?",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          International Conference 2025 | FAQ | Registrations | ICMDRSE
        </title>
        <meta
          name="description"
          content="ICMDRSE 2025 Registration FAQ covers topics like member discounts, group discounts, what the registration fee includes, payment methods, and policies for transfers."
        />
      </Helmet>
      <div className="serviceDetails">
        <BreadCumb
          bgImg="assets/img/page_heading_1.jpg"
          Title="Conference FAQ"
        />
        <div className="mt-3">
          <TopContent
