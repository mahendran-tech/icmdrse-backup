...
const PublicationOpp = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Scopus Index Journals and Publication | Researchers | ICMDRSE 2025
        </title>
        <meta
          name="description"
          content="ICMDRSE 2025 offers researchers access to top journals for publication. Explore guidelines, indexing, and steps to get your research published"
        />
      </Helmet>
