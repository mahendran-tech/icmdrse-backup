...
const Session2 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Physical and Life Sciences Conference | Call For Paper | ICMDRSE 2025
        </title>
        <meta
          name="description"
          content="Join ICMDRSE 2025 to explore the latest developments and research in engineering, social science and humanities conference. Discover key insights on Physical and Life Sciences is contribution to the Sustainable Development Goals from leading experts"
        />
      </Helmet>
