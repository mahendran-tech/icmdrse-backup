...
const AboutIferp = () => {
  return (
    <>
      <Helmet>
        <title>
          About IFERP | Empowering Researchers Through Knowledge and Innovation
        </title>
        <meta
          name="description"
          content="IFERP is a premier platform for researchers and engineers, dedicated to promoting global collaboration, research advancements, and innovation in engineering, science, and technology through conferences, workshops, and professional networking"
        />
      </Helmet>
