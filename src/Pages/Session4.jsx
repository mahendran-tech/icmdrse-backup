...
const Session4 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Business, Management Studies & Accounting Conference | Call For Paper
          | ICMDRSE 2025
        </title>
        <meta
          name="description"
          content="Join ICMDRSE 2025 to explore the latest developments and research in engineering, social science and humanities conference. Discover key insights on Innovative In Business, Management Studies & Accounting is contribution to the Sustainable Development Goals from leading experts"
        />
      </Helmet>
      <div className="serviceDetails">
        <BreadCumb
          bgImg="assets/img/page_heading_1.jpg"
          Title="Business, Management  Studies & Accounting"
        />
        <TopContent2
