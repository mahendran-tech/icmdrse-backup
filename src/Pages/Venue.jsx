...
const Venue = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Conference Venue | May Month Conference Malaysia | ICMDRSE 2025
        </title>
        <meta
          name="description"
          content="Discover the venue details for the International Conference on Multidisciplinary Research in Science and Engineering (ICMDRSE). Join us at Corus Hotel Kuala Lumpur, Malaysia, to connect with global researchers and innovators."
        />
      </Helmet>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        Wilayah Persekutuan Kuala Lumpur, Malaysia +60 3-2161
                        8888
                      </p>
                    </div>
                  </div>
              ...
              <ul className="cs_list cs_style_1 cs_fs_16  cs_heading_font cs_mb_10 p-0">
                <li>
                  ...
                  <span>
                    ...
                    Academy will not directly contact embassies and consulates
                    on behalf of visa applicants. All delegates or invitees
              ...
              <ul className="cs_list cs_style_1 cs_fs_16  cs_heading_font cs_mb_10 p-0">
                <li className="flex-column">
                  <span>
                    ...
                    Travel Card (ABTC) with the "MYS" code can travel to
                    Malaysia without a visa for up to 60 days. The ABTC, valid
                    for five years, facilitates easier travel across APEC
                    economies by eliminating the visa requirement once
                    pre-clearance is granted during the application process.
                  </span>
                  <hr />
            ...
            <div
              ...
              <ul className=" w-75 align-content-center cs_list cs_style_1 cs_fs_16  cs_heading_font cs_mb_10 p-0">
                ...
                <li className="flex-column">
                  <span>
                    <b className="cs_heading_color cs_semibold"> </b>
                    To apply for an eVisa for the 8th International Conference
                    on Medical and Dental Research in Southeast Asia (ICMDRSE)
                    in Malaysia, please follow these steps:
                  </span>
                  ...
                  <ul className=" gap-2">
                    ...
                    <li className="mt-3">
                      The eVisa simplifies the entry process, making it easier
                      for conference attendees to travel to Malaysia and
                      participate in the event. If you encounter any issues
                      receiving your invitation, we encourage you to contact us
                      promptly. Our dedicated team is here to assist you in
                      ensuring a smooth visa application process, providing any
                      necessary support or documentation to facilitate your
                      travel to Malaysia for the event.
                    </li>
                  </ul>
                </li>
              </ul>
          ...
          <div className="row mt-5 py-4 px-4 rounded-3 border-dark-subtle border border-opacity-25 border-primary">
            ...
            <div className="col-lg-12 mt-4">
              ...
              <ul>
                ...
                <li>
                  {" "}
                  <b>Step 3: </b> Alight at the <b> KLCC Station</b> (Corus
                  Hotel is a short 5-minute walk from here).
                </li>
                <li>
                  {" "}
                  <b>Duration: </b> 1 hour.
          ...
          <div className="row mt-5 mb-2 py-4 px-4 rounded-3 border-dark-subtle border border-opacity-25 border-primary">
            <div className="col-lg-6 col-md-12 mt-4">
              ...
              <ul>
                ...
                <li>
                  {" "}
                  <b>Step 3: </b> Alight at the <b> KLCC Station </b> and walk
                  to Corus Hotel.
                </li>
                <li>
                  {" "}
