        ...
        <div className="row">
          <div className="col-lg-7 col-sm-12">
            ...
            <ul className="list-group list-edit">
              ...
              <li className="list-group-item">
                After registering, participants must email us a scanned copy of
                the registration fee receipt or transaction proof.
              </li>
              <li className="list-group-item">
              ...
              <li className="list-group-item">
                Following payment, download the Registration Form, complete it,
                and send it to info@icmdrse.com
              </li>
            </ul>
          </div>
