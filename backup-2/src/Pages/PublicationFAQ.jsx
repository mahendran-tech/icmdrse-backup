...
const PublicationFAQ = () => {
  const faqs = [
    {
      question: "Q.1: I am a member of IFERP. Do I get a discount? How can I register?",
      answer:
    ...
    },
    {
      ...
      answer:(<> Your registration includes: <ul className="ms-5">
    ...
    {
      question:
        "Q.4: Is there a discount for groups of 5 or more?",
      answer:
    ...
    {
        question:
          "Q.7: Can I get a payment receipt with taxes included?",
        answer:
          "Absolutely! We’ll provide a payment receipt inclusive of taxes."
      },
      {
        question:
          "Q.8:  Can you include my university name on the receipt?",
        answer:
      ...
      {
        question:
          "Q.10:  Can I register after the deadline?",
        answer:
