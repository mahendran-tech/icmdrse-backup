...
const SubmissionFAQ = () => {
  const faqs = [
    {
      question: "Q.1: If my abstract is not accepted, can I still attend the conference?",
      answer:
    ...
    },
    {
      ...
      answer:(<> To submit your abstract, please use the Abstract Template available via the Abstract Page link. If you experience any issues, you can also email your abstract to <a href="mailto:info@icmdrse.com.">info@icmdrse.com </a> </>)
    ...
    },
    {
      ...
      },
      {
        ...
        answer:
          "A full paper can be between 6 to 8 pages in length."
      },
      {
        question:
      ...
      {
        question:
          "Q.12: What is the word limit for the abstract?",
        answer:
  ...
  return (
    <div className="serviceDetails">
      <BreadCumb bgImg="assets/img/page_heading_1.jpg" Title="Submission FAQ" />
      <div className="mt-3">
