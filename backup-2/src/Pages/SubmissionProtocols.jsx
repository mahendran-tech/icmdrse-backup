                ...
                description: (
                  <>
                    ...
                    <div className="d-flex gap-40 mt-3 ">
                      ...
                      <ul>
                        <li>
                          <i className="bi bi-dot text-primary"></i> Background
                        </li>
                        <li>
                          <i className="bi bi-dot text-primary"></i> Motivation
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <i className="bi bi-dot text-primary"></i> Discussions
                        </li>
                        <li>
                          <i className="bi bi-dot text-primary"></i> Conclusions
                        </li>
                      </ul>{" "}
                    </div>
                  </>
